    ...
    <div id="inner-sanctum" className={`layer ${isActive ? 'active' : ''}`}>
      ...
      {!missionTerminated && (
        <div className="folder-perspective-wrapper">
          <div className={`folder-3d-scene ${(phase === 'revealed' || phase === 'folder-opening' || phase === 'case-closed') ? 'open' : ''} ${phase === 'folder-closed' ? 'visible-closed' : ''} ${phase === 'revealed' ? 'revealed' : ''} ${phase === 'case-closed' ? 'case-closed' : ''}`}>
      ...
      )}{/* end folder-perspective-wrapper */}
